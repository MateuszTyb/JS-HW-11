...
async function findImage(name, page) {
  try {
    ...
    return _notiflix.default.Notify.failure('Error!');
  }
}
...
searchButton.addEventListener('click', event => {
  ...
  findImage(input.value, pageNumber).then(res => {
    if (input.value === '') {
      _notiflix.default.Notify.failure('Put some name.');
    } else if (res.total === 0) {
      _notiflix.default.Notify.failure('Sorry, there are no images matching your search query. Please try again.');
    } else {
      _notiflix.default.Notify.success(`We found ${res.total} images.`);
...
function createGallery() {
  ...
  _notiflix.default.Notify.info(`Display ${imageCounter} from ${totalHits} images`);
...
},{"axios":"../node_modules/axios/index.js","notiflix":"../node_modules/notiflix/dist/notiflix-aio-3.2.2.min.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
